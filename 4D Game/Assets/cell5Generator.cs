...
public class cell5Generator : MonoBehaviour {
  MeshFilter meshFilter;
	...
	void Start () {
		...
		originalVerts = new List<Vector4>(){
			new Vector4(80,80,80,-80/Mathf.Sqrt(5)),
			new Vector4(80,-80,-80,-80/Mathf.Sqrt(5)),
			new Vector4(-80,80,-80,-80/Mathf.Sqrt(5)),
			new Vector4(-80,-80,80,-80/Mathf.Sqrt(5)),
			new Vector4(0,0,0,320/Mathf.Sqrt(5))
		};
  ...
  void OnGUI() {
    ...
    CreatePlane(rotatedVerts[0],rotatedVerts[4],rotatedVerts[2]);
    CreatePlane(rotatedVerts[0],rotatedVerts[3],rotatedVerts[1]);

    CreatePlane(rotatedVerts[1],rotatedVerts[3],rotatedVerts[2]);
    CreatePlane(rotatedVerts[1],rotatedVerts[4],rotatedVerts[3]);
    CreatePlane(rotatedVerts[1],rotatedVerts[2],rotatedVerts[4]);
	...
	void CreatePlane (Vector3 p1,Vector3 p2,Vector3 p3) {
